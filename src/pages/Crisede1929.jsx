...
<center>
          ...
          <article className="Bloco-OqFoi bloco-destacavel">
            ...
            <center>
              ...
              <div className="Texto-OqFoi">
                <p>
                  A Crise de 1929, que ocorreu entre a Primeira e a Segunda
                  Guerra Mundial, foi um dos eventos mais significativos da
                  História Moderna. Esta crise aconteceu entre os meses de
                  setembro e outubro de 1929 nos Estados Unidos, onde o valor
                  das ações da Bolsa de Valores de Nova York caiu drasticamente,
                  causando sua "quebra" (crash). Por sua vez, o colapso da Bolsa
                  de Nova York provocou a Grande Depressão Americana, que
          ...
          <div className="Texto-Antecedentes">
            ...
            <div className="Para-Antece">
              <p>
                ...
                superprodução e consumo excessivo, criando o American Way of
                Life, focado no consumo e na classe média.A Europa dependia de
                ajuda financeira dos EUA para se reconstruir, e os americanos
                ...
                liberalismo econômico, e o princípio da não intervenção do
                Estado na economia. Com isso, não havia fiscalização sobre o
                mercado financeiro nem controle sobre os créditos concedidos,
                tanto aos consumidores internos quanto aos países estrangeiros.
                Essa ausência de regulação contribuiu para o desequilíbrio que
                mais tarde levaria à crise de 1929.
              </p>
            </div>
          </div>
        </article>
        ...
        <article className="Bloco-Bolsa bloco-destacavel">
          ...
          <div className="Texto-Bolsa">
            ...
            <div className="Para-Bolsa">
              <p>
                Em 1929, a Bolsa de Valores de Nova York entrou em colapso,
                dando início à Grande Depressão. Nos anos anteriores, os EUA
                viviam um forte crescimento econômico, e muitas pessoas
                investiam na bolsa, muitas vezes com dinheiro emprestado, o que
                gerou uma bolha especulativa. Em 24 de outubro, a "quinta-feira
                negra", os preços das ações começaram a cair rapidamente, e o
                pânico se intensificou em 29 de outubro, a "terça-feira negra".
                Milhares de pessoas perderam tudo, empresas faliram, o
                desemprego disparou e a crise se espalhou pelo mundo. Como
                resposta, os EUA mudaram as regras do mercado financeiro.
              </p>
            </div>
          </div>
        </article>
            ...
            <center>
              <div className="Texto-New">
                <p>
                  ...
                  Roosevelt, na década de 1930, com o objetivo de combater a
                  Grande Depressão, que teve início em 1929. A meta principal
                  era amenizar as consequências da crise econômica, impulsionar
                  a recuperação e evitar futuras recessões econômicas.
                </p>
              </div>
            </center>
          </article>
            ...
            <center>
              <div className="Texto-Conse">
                <p>
                  ...
                  desemprego aumentou para 27%, as importações diminuíram em 70%
                  e as exportações, em 50%. Os financiamentos internacionais
                  caíram 90%, ao passo que a produção industrial teve uma queda
                  de aproximadamente um terço. A produção de automóveis diminuiu
                  50%, o salário médio na indústria diminuiu 50%, e milhares de
                  empresas e instituições financeiras entraram em falência.
                  Milhares de indivíduos perderam de imediato todo o seu
                  patrimônio, uma vez que estava aplicado em ativos
                  especulativos que sumiram com o colapso da bolsa. Os impactos
                  da crise se disseminaram globalmente, resultando em várias
                  economias em recessão e gerando uma onda de desemprego em
                  escala mundial.
                </p>
              </div>
            </center>
        ...
        <section className="JuntosC">
          <article
            className="Bloco-VideoC bloco-destacavel"
          ...
          >
            ...
            <div className="Texto-VideoC">
              <p>
                ...
                diferentes. O American Way of Life é a nova forma de viver a
                vida. Um caminho próspero em direção à riqueza. Milhares de
                modelos Ford invadiram as ruas americanas, os eletrodomésticos
                ganhavam cada vez mais espaço e agora você pode ouvir seu
                programa favorito no rádio ou ver Charlie Chaplin no cinema. A
                América prosperava de uma forma nunca antes vista até 1929.{" "}
              </p>
            </div>
          </article>

          <article
            className="Bloco-FilmeC bloco-destacavel"
            style={{ textAlign: "center" }}
          >
            <header>
              <h2 className="Titulo-VideoC">
            ...
            <div className="Texto-VideoC">
              <p>
                Após a Primeira Guerra Mundial, em 1918, os EUA eram a nação
                mais rica do mundo, destacando-se na produção de automóveis,
                aço, comida enlatada, petróleo e carvão. Nos anos seguintes, a
                economia americana cresceu, gerando otimismo entre os
                empresários e a popularização do “American Way of Life”. A
                década de 1920, chamada de “Loucos Anos 20”, foi marcada pelo
                aumento do consumo, crescimento da indústria e a popularização
                do cinema. Contudo, essa prosperidade era ilusória e culminou na
                Grande Crise de 1929, conhecida como “Quinta-Feira Negra”,
                devido à queda brusca das ações na Bolsa de Nova York. A
                superprodução agrícola e a diminuição do consumo foram alguns
                dos fatores que provocaram a crise. O governo, liderado por
                Roosevelt, implementou o New Deal em 1933, com medidas para
                recuperar a economia e diminuir o desemprego. A Grande Depressão
                só foi superada com o início da Segunda Guerra Mundial.
              </p>
            </div>
          </article>
        </section>
