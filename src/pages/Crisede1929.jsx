...
function Crisede29() {
  ...
  return (
    <>
    <Navbar />
      <div className="Bloco-CarrosselC">
      ...
      <center>
        <div className="Bloco-Bolsa">
          <div className="Bloco-Img">
            <img className="Img-Bolsa" src={ImgBolsa}></img>
          </div>
      ...
      <div className="Blocos-AnteFim">
        <div className="Bloco-New">
          <center>
            <br></br>
            <img className="Img-New" src={ImgNew}></img>
            <div className="Titulo-New">
              <h2>New Deal</h2>
            </div>
            <div className="Texto-New">
              <p>
                ...
                Grande Depressão, que teve início em 1929. A meta principal era
                amenizar as consequências da crise econômica, impulsionar a
                recuperação e evitar futuras recessões econômicas.
              </p>
            </div>
          </center>
        </div>

        <div className="Bloco-Conse">
          <center>
            <div className="Titulo-Conse">
              <h2>Consequências</h2>
            </div>
            <br></br>
            <img className="Img-Conse" src={ImgFConse}></img>
            <br></br>
            <br></br>
      ...
      <hr></hr>
        ...
        <div className="JuntosC">
          <div className="Bloco-VideoC">
            <center>
            ...
            <center>
              <div className="Texto-VideoC">
                <p>
                  ...
                  Europa havia quebrado. A crise financeira tomava conta de
                  países como a Alemanha, o Império Otomano e a Iugoslávia
                  enquanto isso, do outro lado do Atlântico as coisas pareciam
                  um pouquinho diferentes. O American Way of Life é a nova forma
                  de viver a vida. Um caminho próspero em direção à riqueza.
                  Milhares de modelos Ford invadiram as ruas americanas, os
                  eletrodomésticos ganhavam cada vez mais espaço e agora você
                  pode ouvir seu programa favorito no rádio ou ver Charlie
                  Chaplin no cinema. A América prosperava de uma forma nunca
                  antes vista até 1929.{" "}
                </p>
              </div>
            </center>
          </div>

          <div className="Bloco-FilmeC">
            <center>
              <h2 className="Titulo-VideoC">
            ...
            <center>
              <div className="Texto-VideoC">
                <p>
                  ...
                  do cinema. Contudo, essa prosperidade era ilusória e culminou
                  na Grande Crise de 1929, conhecida como “Quinta-Feira Negra”,
                  ...
                  recuperar a economia e diminuir o desemprego. A Grande
                  Depressão só foi superada com o início da Segunda Guerra
                  Mundial.
                </p>
              </div>
            </center>
